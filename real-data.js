...
db.booths.insert({ "boothId" : "THINK1", "unit" : "Secret Map", "description" : "AR, Kubernetes, Blockchain, IoT, etc!", "measurementUnit" : "metre", "shape" : {"type": "rectangle", "x" : 843, "y" : 764, "width" : 140, "height" : 58}, "contact" : "John Doe" });
db.booths.insert({ "boothId" : "THINK2", "unit" : "Server Challenge", "description" : "Challenge the Server", "measurementUnit" : "metre", "shape" : {"type": "rectangle", "x" : 925, "y" : 832, "width" : 58, "height" : 58}, "contact" : "Mary Jane" });
db.booths.insert({ "boothId" : "THINK3", "unit" : "Infinity Portal", "description" : "To infinity and beyond!", "measurementUnit" : "metre", "shape" : {"type": "rectangle", "x" : 659, "y" : 761, "width" : 87, "height" : 87}, "contact" : "Jane Doe" });
db.booths.insert({ "boothId" : "THINK4", "unit" : "With Watson Studio", "description" : "Watson space", "measurementUnit" : "metre", "shape" : {"type": "rectangle", "x" : 419, "y" : 909, "width" : 146, "height" : 146}, "contact" : "Smith John" });
...
db.booths.insert({ "boothId" : "THINK7", "unit" : "Games", "description" : "Play the classic Connect 4", "measurementUnit" : "metre", "shape" : {"type": "rectangle", "x" : 615, "y" : 1122, "width" : 175, "height" : 58}, "contact" : "Joe Myers" });
db.booths.insert({ "boothId" : "THINK10", "unit" : "Food Beverages", "description" : "Have a break!", "measurementUnit" : "metre", "shape" : {"type": "rectangle", "x": 420, "y": 1113, "width": 146, "height": 58}, "contact" : "Joe Myers" });
db.booths.insert({ "boothId" : "THINK11", "unit" : "Watson Demos", "description" : "Some cool Watson Demos", "measurementUnit" : "metre", "shape" : {"type": "rectangle", "x": 419, "y": 761, "width": 146, "height": 118}, "contact" : "Joe Myers" });
...
db.booths.insert({ "boothId" : "THINK13", "unit" : "Games", "description" : "Some cool tabletop games", "measurementUnit" : "metre", "shape" : {"type": "rectangle", "x": 583, "y": 638, "width": 238, "height": 51}, "contact" : "Joe Myers" });
...
db.booths.insert({ "boothId" : "THINK21", "unit" : "Team Labs", "description" : "Lab with others", "measurementUnit" : "metre", "shape" : {"type": "rectangle", "x": 324, "y": 352, "width": 29, "height": 117}, "contact" : "Joe Myers" });
db.booths.insert({ "boothId" : "THINK22", "unit" : "Team Labs", "description" : "Lab with others", "measurementUnit" : "metre", "shape" : {"type": "rectangle", "x": 324, "y": 509, "width": 29, "height": 58}, "contact" : "Joe Myers" });
db.booths.insert({ "boothId" : "THINK23", "unit" : "Team Labs", "description" : "Lab with others", "measurementUnit" : "metre", "shape" : {"type": "rectangle", "x": 324, "y": 607, "width": 29, "height": 114}, "contact" : "Joe Myers" });
...
db.booths.insert({ "boothId" : "THINK50", "unit" : "Food Beverages", "description" : "Have a break!", "measurementUnit" : "metre", "shape" : {"type": "rectangle", "x": 840, "y": 1113, "width": 117, "height": 58}, "contact" : "Joe Myers" });
db.booths.insert({ "boothId" : "THINK51", "unit" : "Snack Tracker", "description" : "Have a snack!", "measurementUnit" : "metre", "shape" : {"type": "rectangle", "x": 902, "y": 923, "width": 23, "height": 36}, "contact" : "Joe Myers" });
db.booths.insert({ "boothId" : "THINK52", "unit" : "Hacked Two Minutes", "description" : "Hacked in two minutes!", "measurementUnit" : "metre", "shape" : {"type": "rectangle", "x": 843, "y": 832, "width": 58, "height": 58}, "contact" : "Joe Myers" });
db.booths.insert({ "boothId" : "THINK53", "unit" : "X-Force Command Center", "description" : "Command Center", "measurementUnit" : "metre", "shape" : {"type": "rectangle", "x": 840, "y": 1218, "width": 88, "height": 88}, "contact" : "Joe Myers" });
db.booths.insert({ "boothId" : "THINK8", "unit" : "Hands-on Labs", "description" : "Have a break!", "measurementUnit" : "metre", "shape" : {"type": "rectangle", "x": 447, "y": 1218, "width": 118, "height": 89}, "contact" : "Joe Myers" });
db.booths.insert({ "boothId" : "THINK9", "unit" : "Tech Talks", "description" : "Talks about cool technologies", "measurementUnit" : "metre", "shape" : {"type": "rectangle", "x": 615, "y": 1218, "width": 177, "height": 89}, "contact" : "Joe Myers" });
